...
function Layout() {
  ...
  <div className="  fixed top-0     z-50  w-full lg:hidden ">
        ...
        <div className="flex flex-col items-center  xl:flex-row  xl:gap-8    flex-grow   h-screen overflow-y-scroll xl:overflow-hidden lg:pl-24 xl:pl-0 ultra:pl-24  ultra:flex-col ultra:overflow-y-scroll pt-14 lg:pt-0">
