...
Transforming web visions into user-friendly realities—where innovative design meets flawless functionality.
            ...
            <SecondaryBtn className="font-semibold py-5" text="Hire me" icon={IoIosSend}  onClick={()=>handleScrollToContact()}/>
