...
function Section() {
      ...
      <div className="pt-5 space-y-10">
        ...
        <div className="h-80 md:h-60 w-full rounded-3xl overflow-hidden relative group cursor-pointer">
          ...
          <div className="absolute z-10 top-0 w-full h-full px-4 md:px-10 py-3 md:py-10">
            ...
            <span className="text-white  text-sm font-semibold  opacity-0 translate-y-2 group-hover:opacity-100 group-hover:translate-y-0 transition-all duration-300">MERN Stack Development.</span>
 ...
 <span className="text-gray-300 text-sm font-semibold  opacity-0 translate-y-2 group-hover:opacity-100 group-hover:translate-y-0 transition-all duration-300">                  React, Ant Design, React Query, Axios, React Hook Form, REST APIs
                </span>
              </div>
            ...
            <div className="mt-5 text-white font-semibold opacity-0 translate-y-2 group-hover:opacity-100 group-hover:translate-y-0 transition-all duration-300">
              <a
                href="https://shop-co-vert-mu.vercel.app/"
                target="_blank"
              >
                Visit Project →
              </a>
